...
describe('DocObject', () => {
  ...
  it('should correctly construct document object', (done) => {
    wsPromise.then((res) => {
      const docObj = new DocObject('C11', 'C12:I12', res.ws);      
      done();
    });
  });
  ...
  //           docObj1 = new DocObject('C12', 'C12:I12', res.ws, 'C10:C20', parentFG),
  //           docObj2 = new DocObject('C13', 'C13:I13', res.ws, 'C10:C20', parentFG),
  //           docObj3 = new DocObject('C13', 'C13:I13', res.ws, 'C10:C20', parentFG);
  ...
  it('should collect all object children by the given child color and set them ' +
    ...
    wsPromise.then((res) => {
      const fg1 = res.ws.getCell('C10').fill.fgColor,
            ...
            docObj1 = new DocObject('C11', 'C11:I11', res.ws, 'C10:C27', null, 'empty', fg2),
            docObj2 = new DocObject('C15', 'C15:I15', res.ws, 'C10:C27', null, 'empty', fg2),
            docObj3 = new DocObject('C10', 'C10:I10', res.ws, 'C10:C27', null, fg2, fg1),
            docObj4 = new DocObject('C19', 'C19:I19', res.ws, 'C10:C27', null, fg2, fg1);
  ...
  it('should return children range of a given parent', (done) => {
    wsPromise.then((res) => {
      const my1FG = res.ws.getCell('C11').fill.fgColor,
            ...
            const docObj1 = new DocObject('C11', 'C11:I11', res.ws, 'C10:C27', my2FG, null, my1FG),
                  docObj2 = new DocObject('C10', 'C10:I10', res.ws, 'C10:C27', null, null, my2FG),
                  docObj3 = new DocObject('C15', 'C15:I15', res.ws, 'C10:C27', my2FG, null, my1FG),
                  docObj4 = new DocObject('C19', 'C19:I19', res.ws, 'C10:C27', null, null, my2FG),
                  docObj5 = new DocObject('C20', 'C20:I20', res.ws, 'C10:C27', null, null, my1FG);
